        ...
        <>
            <div className=" h-[100vh] w-[calc(100vw-0px)] flex flex-col items-start gap-3 rounded-lg">
                <div className="w-100 h-[50px] flex items-center  text-center border-l-2 border-b-2 shadow-1 border-red rounded-bl-lg">
                    <form action="col" className='flex w-100 items-center justify-between px-4 gap-5 '>
                        ...
                        <div className="col-2relative">
                            <Select
                                ...
                                className="w-100 absolute z-30 bs-transparent focus:outline-0" onChange={(roomnumber) => { setRoomselector("roomnumber", roomnumber); }}
                            />
                        </div>
                        {/* <div className="flex gap-3 w-fit h-fit items-center">
                            <div className="">
                                <p className='fs-8 text-center font-semibold tx-red'>Adults(12+ yr)</p>
                                <div className="flex items-center shadow-md w-fit mx-auto">
                                    <div className="px-3 rounded-l-md bs-red pointer" onClick={adultdecNum}>
                                        <i className="fa-solid fa-minus tx-white fs-8"></i>
                                    </div>
                                    ...
                                    <div className="px-3 rounded-r-md bs-red pointer" onClick={adultincNum}>
                                        <i className="fa-solid fa-plus tx-white fs-8"></i>
                                    </div>
                                </div>
                            </div>
                            <div className="">
                                <p className='fs-8 text-center font-semibold tx-red'>Children(0-12 yr)</p>
                                <div className="flex items-center shadow-md w-fit mx-auto">
                                    <div className="px-3 rounded-l-md bs-red pointer" onClick={childrendecNum}>
                                        <i className="fa-solid fa-minus tx-white fs-8"></i>
                                    </div>
                                    <input type="text" className="font-semibold text-center min-w-[30px] !max-w-[30px]" value={childrennum} onChange={childrenhandleChange} />
                                    <div className="px-3 rounded-r-md bs-red pointer" onClick={childrenincNum}>
                                        <i className="fa-solid fa-plus tx-white fs-8"></i>
                                    </div>
                                </div>
                            </div>
